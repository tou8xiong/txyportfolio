            ...
            <div id="homesection" className="flex justify-around border-0 pt-10">
                <div className="border-0 p-5 ">
                    ...
                    <div className="flex border-0 w-fit gap-1 bg-white justify-center rounded">
                        ...
                        <a href="https://github.com/tou8xiong"  ><FaSquareGithub size={45} color="black" /></a>
                    </div>
                </div>
                <div className=" h-fit" >
                    <Image src={Myimage} alt="image" className="w-70 rounded-2xl  transition  duration-300 hover:shadow-xl
                     shadow-black hover:scale-105" />
                </div>
                <div>
                    <p className="font-bold">ASPIRING</p>
                    <h2 className=" font-bold underline-offset-2 underline">FULL-STACK Developer </h2>
